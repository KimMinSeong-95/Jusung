...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpfnWndProc    = WndProc; //포수이름 등록
    ...
    case WM_PAINT:
        {
            ...
            SetTextAlign(hdc, TA_RIGHT); // 센터 중심으로 //정렬

            TextOut(hdc, 100, 100, _T("COME ON"), 7);
            TextOut(hdc, 100, 200, _T("김민성 만세"), 3);
            TextOut(hdc, 100, 300, _T("ㄷㅈㄱ제가러ㅏㅣㄴㅇ러ㅣ넉마ㅣㅓㄷ기"), 10);

            //SetDCPenColor(hdc, WHITE_BRUSH);
