...
{
    void CalcFare() { m_nFare = DEFAULT_FARE * 1; };
};
...
int main()
{
    ...
    //CPerson arListTest[3];//정적메모리
    CPerson** arList = new CPerson * [nCount];//동적메모리
    ...
    // 3. 자료 삭제 및 종료
    for (int i = 0; i < nCount; i++)  delete arList[i];
    delete[] arList;
